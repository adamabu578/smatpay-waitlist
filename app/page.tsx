...
// EmailJS Credentials
const SERVICE_ID = "service_n5ev2m5"
const TEMPLATE_ID = "template_rv1jv3i"
const PUBLIC_KEY = "e9Tht_Br8bnu563wU"
...
export default function WaitlistPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success!",
        description: "You've been added to our waitlist and we've received your email.",
        variant: "default",
      })
    } catch (error) {
      toast({
      ...
      <div className="container px-4 py-16 mx-auto max-w-6xl">
        ...
        >
          ...
          >
            ...
            <span className="text-4xl"><span className="text-purple-500 text-4xl">Smatpay</span> Coming Soon</span>
          </motion.div>
          ...
          >
            Be the first to experience our revolutionary product when it launches.
          </motion.p>
        </motion.div>
